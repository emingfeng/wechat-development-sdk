...
namespace eMingFeng\OfficialAccount\SubscribeMessage;
 ...
 * 订阅消息
 * Class Room
 * @package eMingFeng\OfficialAccount\SubscribeMessage
 * @officialAccount doc https://developers.weixin.qq.com/doc/offiaccount/Subscription_Messages/api.html
 */
...
class Client extends BaseClient
{
     ...
     * @return array
     */
    public function getPubTemplateTitleList(string $ids, int $start = 0, int $limit = 30)
    {
     ...
     * @param array $miniprogram 跳转小程序时填写，格式如{ "appid": "pagepath": { "value": any } }
     * @param array $data 模板内容，格式形如 { "key1": { "value": any }, "key2": { "value": any } }
     * string $touser, string $template_id, string $page = null, array $miniprogram = [], array $data
     * @return array
     */
    public function bizSend(array $params)
    {
